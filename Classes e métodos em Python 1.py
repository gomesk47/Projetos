...
class Pessoa:
    ...
    def __init__(self, nome, idade, genero):
        ...
        # Atribui o valor de nome ao atributo nome da instância.
        self.nome = nome

        # Atribui o valor de idade ao atributo idade da instância.
        self.idade = idade

        # Atribui o valor de gênero ao atributo gênero da instância.
        self.genero = genero
